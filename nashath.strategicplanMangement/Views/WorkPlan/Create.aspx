...
<% Using Html.BeginForm() %>
    ...
    <%: Html.ValidationSummary(True) %>
        ...
        <div class="editor-label">
            <%: Html.LabelFor(Function(model) model.StrategicActivityID, "StrategicActivity") %>
        </div>
...
<div>
    <%: Html.ActionLink("Back to List", "Details", "StrategicActivity", New With {.id = RouteData.Values("id")}, "")%>
</div>
